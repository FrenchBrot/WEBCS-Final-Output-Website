...
- automated email response using emailJS
- JS disables: copy+paste, right-click, click+drag, F12 for dev-tools
- JS/CSS typewriting effect for selected text
- JS/CSS lightbox effect for photos
- CSS dark mode, changed through default theme of browser.
